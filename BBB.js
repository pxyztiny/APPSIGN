...
if (!COOKIE.bububaotokenVal) {
    ...
    bububaotokenArr=[{"imei":"6e85025e-f87c-46b3-adea-5cde20865bac","ini":"29","version":"18","tokenstr":"B4438A6B3A2EDD6688E1A73C1532500G1614653034","store":"0","platform":"1","Content-Type":"application/x-www-form-urlencoded","User-Agent":"Dalvik/2.1.0 (Linux; U; Android 10; GLK-AL00 Build/HUAWEIGLK-AL00)","Host":"bububao.duoshoutuan.com","Connection":"Keep-Alive","Accept-Encoding":"gzip","Content-Length":"0"}]
    if (bububaotokenArr == '') {
        Length = 0
...
async function all() {
    ...
    for (let i = 0; i < Length; i++) {
        ...
        header ={"imei":"6e85025e-f87c-46b3-adea-5cde20865bac","ini":"29","version":"18","tokenstr":"B4438A6B3A2EDD6688E1A73C1532500G1614653034","store":"0","platform":"1","Content-Type":"application/x-www-form-urlencoded","User-Agent":"Dalvik/2.1.0 (Linux; U; Android 10; GLK-AL00 Build/HUAWEIGLK-AL00)","Host":"bububao.duoshoutuan.com","Connection":"Keep-Alive","Accept-Encoding":"gzip","Content-Length":"0"};
        O = (`${$.name + (i + 1)}🔔`);
        await console.log(`-------------------------\n\n🔔开始运行【${$.name + (i + 1)}】`)
